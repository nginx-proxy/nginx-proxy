...
![nginx 1.17.8](https://img.shields.io/badge/nginx-stable-brightgreen.svg) ![License MIT](https://img.shields.io/badge/license-MIT-blue.svg) [![Build Status](https://travis-ci.org/adamus1red/nginx-proxy.svg?branch=master)](https://travis-ci.org/adamus1red/nginx-proxy) [![](https://img.shields.io/docker/stars/adamus1red/nginx-proxy.svg)](https://hub.docker.com/r/adamus1red/nginx-proxy 'DockerHub') [![](https://img.shields.io/docker/pulls/adamus1red/nginx-proxy.svg)](https://hub.docker.com/r/adamus1red/nginx-proxy 'DockerHub')
